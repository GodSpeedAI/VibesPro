use arc_console::api;
use arc_console::launch;
use arc_console::process;
...
#[derive(Parser, Debug)]
#[command(name = "arc-console")]
#[command(about = "Web console for monitoring and managing arc instances")]
struct Args {
    /// Port to bind to
...
async fn main() -> anyhow::Result<()> {
    ...
    info!("Starting arc-console on http://{}", addr);
