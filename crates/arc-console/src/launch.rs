...
pub struct ConsoleState {
    ...
    pub arc_binary_path: Option<String>,
...
impl ConsoleState {
    ...
    fn config_path() -> PathBuf {
        // Use explicit ~/.config/arc/console.json path as per requirements
        let home = dirs::home_dir().unwrap_or_else(|| PathBuf::from("."));
        home.join(".config").join("arc").join("console.json")
    }
}
