...
function ChatView({ messages, toolCalls }) {
  ...
  if (messages.length === 0 && toolCalls.length === 0) {
    return <div className="text-center text-gray-600 dark:text-gray-400 py-8">No messages yet</div>;
  }
  ...
  return (
    <div className="space-y-4 max-h-[600px] overflow-y-auto">
      ...
      {toolCalls.length > 0 && (
        <div className="mt-6">
          <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Tool Calls</h4>
