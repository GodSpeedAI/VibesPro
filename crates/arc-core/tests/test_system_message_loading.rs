...
use arc_core::ContextWindow;
use arc_providers::{Message, MessageRole};
...
fn test_system_prompt_is_first_message() {
    ...
    let system_prompt = "You are ARC, an AI programming agent of the same skill level...";
...
fn test_system_prompt_and_readme_are_separate() {
    ...
    let system_prompt = "You are ARC, an AI programming agent...";
    context.add_message(Message::new(MessageRole::System, system_prompt.to_string()));
...
fn test_todo_is_third_message_after_readme() {
    ...
    // 3. TODO (if present)
    let todo_content = "📋 Existing TODO list (from todo.arc.md):\n\n- [ ] Task 1\n- [x] Task 2";
...
fn test_agents_and_readme_combined() {
    ...
    // Combined AGENTS.md and README.md content (as done in arc-cli)
