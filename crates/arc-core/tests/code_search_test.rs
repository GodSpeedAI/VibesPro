...
use arc_core::code_search::{execute_code_search, CodeSearchRequest, SearchSpec};
use std::fs;

#[tokio::test]
async fn test_find_async_functions() {
    // Create a temporary test file
    let test_dir = std::env::temp_dir().join("arc_test_code_search");
...
async fn test_find_all_functions() {
    // Create a temporary test file
    let test_dir = std::env::temp_dir().join("arc_test_code_search_2");
    fs::create_dir_all(&test_dir).unwrap();
...
async fn test_find_structs() {
    // Create a temporary test file
    let test_dir = std::env::temp_dir().join("arc_test_code_search_3");
    fs::create_dir_all(&test_dir).unwrap();
...
async fn test_context_lines() {
    // Create a temporary test file
    let test_dir = std::env::temp_dir().join("arc_test_code_search_4");
    fs::create_dir_all(&test_dir).unwrap();
...
async fn test_multiple_searches() {
    // Create a temporary test file
    let test_dir = std::env::temp_dir().join("arc_test_code_search_5");
    fs::create_dir_all(&test_dir).unwrap();
...
async fn test_python_search() {
    ...
    let test_dir = std::env::temp_dir().join("arc_test_code_search_python");
    fs::create_dir_all(&test_dir).unwrap();
...
async fn test_javascript_search() {
    ...
    let test_dir = std::env::temp_dir().join("arc_test_code_search_js");
    fs::create_dir_all(&test_dir).unwrap();
