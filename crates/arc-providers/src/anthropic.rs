//! Anthropic Claude provider implementation for the arc-providers crate.
//!
...
//! - Proper message format conversion between arc and Anthropic formats
...
//!
//! ```rust,no_run
//! use arc_providers::{AnthropicProvider, LLMProvider, CompletionRequest, Message, MessageRole};
//!
//! #[tokio::main]
