//! Integration tests for arc-planner

use arc_planner::{create_tool_message, explore_codebase, extract_shell_commands};
use arc_providers::MessageRole;
...
fn test_explore_codebase_returns_report() {
    // Test with current directory (should find Rust files in arc project)
