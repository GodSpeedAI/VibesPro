...
2. Read the `<codepath>/arc-plan/` directory to understand past requirements and implementation history
...
PREPEND them under the heading `{{CURRENT REQUIREMENTS}}` to the `<codepath>/arc-plan/new_requirements.md` file.
