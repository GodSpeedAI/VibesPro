...
Run Exa/GitHub searches and populate the table below with repo links and short notes.

## Placeholder table

| Topic                | Repo example (URL) | Pattern summary                    | Trade-offs         |
| -------------------- | ------------------ | ---------------------------------- | ------------------ |
| Idempotent generator | TODO               | Deterministic writes, marker files | Complexity: medium |

## Notes

This is scaffolding for pattern synthesis; populate with real URLs and snippets when live searches are executed.
